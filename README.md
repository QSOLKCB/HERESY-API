...
HERESY-API expresses that same tiny intent through increasingly ceremonial interfaces and measures the resulting payload.

```bash
python3 heresy.py
```

You will receive a **Ceremony Ratio**: transmitted payload bytes divided by the seven bytes of useful canonical intent.
...
| Raw Socket | 1970s-1980s | Nine bytes. Documentation: `good luck`. |
...
| REST-ish JSON | modern web | At last, human-readable bureaucracy. |
